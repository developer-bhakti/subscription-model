...
export default function ManagementOfAssessmentFreeCoupon() {

  /* =========================
     DIRECT COUPON CODE
  ========================= */

  const couponCode = "OP_ASS_AUG_2026";
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-[30px] shadow-xl p-8 md:p-10">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            ...
            📊 Management Of Assessment Support
          ...
          <p className="text-gray-500 leading-8 text-[15px] mb-8">
            ...
            Use this exclusive Udemy coupon to access premium assessment
            management training. This coupon works for only{" "}
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex justify-center items-center p-5">
          ...
          <div className="bg-white w-full max-w-md rounded-[30px] p-7 relative animate-[popup_0.3s_ease]">
            ...
            <div className="mt-5 space-y-3 text-gray-700 text-sm">
              ...
              <div>✔ Premium Assessment Coupons</div>

              <div>✔ Assessment Training Materials</div>

              <div>✔ Progress Tracking Resources</div>
