...
const levels = {
  ...
  { word: "Bear", emoji: "🐻", answer: "Tear", wrong: ["Fish", "Cup"] },     
  { word: "Cake", emoji: "🎂", answer: "Make", wrong: ["Dog", "Pen"] },       
  { word: "Door", emoji: "🥁", answer: "Four", wrong: ["Fish", "Book"] },    
  { word: "Ear", emoji: "👂", answer: "Tyre", wrong: ["Cup", "Ball"] },       
  { word: "Fire", emoji: "🪭", answer: "Van", wrong: ["Tree", "Pen"] },       
  { word: "Goat", emoji: "🐐", answer: "Boat", wrong: ["Fish", "Book"] },     
  ...
  { word: "Lamp", emoji: "🍃", answer: "Camp", wrong: ["Pen", "Fish"] },      
  ...
  { word: "Quil", emoji: "👸", answer: "Pill", wrong: ["Fish", "Book"] },   
  { word: "Ring", emoji: "💍", answer: "Wing", wrong: ["Cup", "Pen"] },      
  { word: "Seed", emoji: "🌱", answer: "Need", wrong: ["Book", "Fish"] },     
  { word: "Tent", emoji: "🚂", answer: "Bent", wrong: ["Cup", "Ball"] },     
  { word: "Urn", emoji: "👨", answer: "Turn", wrong: ["Fish", "Book"] },  
  ...
  { word: "Queen", emoji: "👸", answer: "Green", wrong: ["Fish", "Pen"] },    
  { word: "Rock", emoji: "🪨", answer: "Sock", wrong: ["Book", "Tree"] },      
  { word: "Star", emoji: "⭐", answer: "Jar", wrong: ["Fish", "Cup"] },         
  { word: "Train", emoji: "🌳", answer: "Rain", wrong: ["Book", "Pen"] },        
  { word: "Uncle", emoji: "⬆️", answer: "Jungle", wrong: ["Fish", "Tree"] },         
