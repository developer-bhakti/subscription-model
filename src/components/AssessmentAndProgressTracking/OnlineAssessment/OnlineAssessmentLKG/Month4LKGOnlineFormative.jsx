...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child writes capital and small English letters A(a) to S (s) by tracing the letters and also without tracing it-Writing skills",
        "The child is able to write Hindi alphabets `Nna` and `Thha` by tracing over it independently ",
        "The child speaks at least 4 words as per the sound of each letter from A to S when asked for it",
        "The child remembers and sings Rhymes easily with action 1. English Rhyme-` Here we go around the mulberry bush` and `Hickory Dickory Dock`",
        "The child can identify and point out the picture when described(Refer last month for example)",
        "The child understands the basic grammar rules like singular and plural (the child identifies between `One` and `many` and uses it correctly)",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
        "The child is able to recite and identify numbers 1 to 20",
        "The child writes the number from 19 to 20 by tracing it and can say the number after writing it",
        "The child is able to understand the time of the day and differentiates between morning, evening and night",
        "The child is able to understand various activities done at different times of the day",
        "The child is able tell the hour time from a watch",
      ],
    },
    ...
    social: {
      ...
      questions: [
        "The child understands the importance of washing hands frequently with soap and right way to do it.",
        "The child understands and differentiates between objects, items and place",
        "The child understands the usefulness of maintaining hand hygiene by cleaning and cutting nails regularly",
        "The child understands the usefulness of drinking enough water",
        "The child understands and identifies the difference between `good touch` and `bad touch`",
        "The child understands the people whom we should trust",
        "The child understands the people whom we should NOT trust",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child understands and can tell what we do and buy from a mall",
        "The child can tell the way we celebrate birthdays",
        "The child can tell various festivals we celebrate",
        "The child is able to tell various religious places we go to",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to trace in sand or mud",
        "The child is able to hop well without any difficulty",
        "The child is able to crawl well without any difficulty",
        "The child is able walk in slow motion without any difficulty",
      ],
    },
  };
