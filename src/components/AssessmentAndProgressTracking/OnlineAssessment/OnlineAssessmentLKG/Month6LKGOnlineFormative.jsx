...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child writes capital and small English letters A(a), W(w) by tracing the letters and also without tracing it (Writing skills are improving)",
        "The child is able to write Hindi letters from `Tha` to `Pha` by tracing over it and without tracing",
        "The child speaks at least 4 words as per the sound of each letter from Ato W.",
        "The child is able to remember and sing favourite Rhymes easily English Rhyme- Early to Bed & Pussy Cat Hindi Rhyme-Savera & Mithuram",
        "Proficiency in recognising and telling the name of the objects whose starting letter sound matches with the sound of the given letter (for both English and Hindi letters)",
        "The child knows and tells his/her full name and other information about self, whenever needed",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
       "The child is able to trace and write numbers from 29 to 36",
       "The child identifies any given number between 1 to 40",
       "The child is able to copy a picture by picking up all the major and minor items in it",
      ],
    },
    ...
    social: {
      ...
      questions: [
         "The child is able to resolve problems with peers (Check the teaching schedule to test this)",
         "The child shows empathy and affection for other kids",
         "The child shares own things/belongings (food / toy /pencil etc) with other friends",
         "The child is able to talk associatively with other children during group play",
         "The child tries to comfort other children who are upset",
         "The child shows self-control and avoids aggression during a conflict with the other children",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child understands and names at least 6-7 domestic animals living around us",
        "The child understands and names at least 6-7 wild animals living in the jungle or zoo",
        "The child understands and names at least 5 pet animals living around us",
        "The child understands and names at least 6-7 water animals living around us",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to crush papers of different sizes and make paper balls (Check for the stiffness level at which the paper is crushed)",
        "The child is able to throw the paper balls into a bin placed one meter away",
        "The child is able to paste ice cream sticks on a paper with glue and make different patterns",
        "The child is able to throw a ball with one hand to a person 4-6 feet away",
        "The child is able to single fold and crease the paper.",
        "The child is able to double fold and crease the paper (with strong marking of the crease.)",
        "The child is able to catch a ball thrown at him/her underarm from 3 feet distance",
      ],
    },
  };
