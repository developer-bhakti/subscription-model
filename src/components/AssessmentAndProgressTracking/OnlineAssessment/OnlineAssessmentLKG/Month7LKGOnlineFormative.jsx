...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child is able read and write capital and small letters from A to Z",
        "The child is able to write Hindi alphabets from `Ba` to `Sha` (check the teaching schedule) by tracing over it and without tracing",
        "The child speaks at least 2 words as per the sound of each letter from `Aa` to `Sha` (Hindi Alphabets).",
        "The child is able to remember and sing favourite Rhymes easily English Rhyme-Row your Boat, Ten in Bed & Traffic light Hindi Rhyme- Chidiya aur Bandar",
        "The child is able to tell the rhyming words of given words",
        "The child writes the English letters as and when dictated",
        "The child is able to read common sight words",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
       "The child is able to copy and write numbers from1 to 50",
       "The child is able to identify any random numbers given between Cognitive Skill",
       "The child is able to differentiate and tell `Tall` or `Short` between two objects The child can count objects upto 20",
       "The child is able to differentiate and tell `Heavy` or `Light` between two objects",
    ...
    social: {
      ...
      questions: [
         "The child is able to do tasks with enough attention span eg: while listening to stories, doing craft activities",
         "The child is able to differentiate between real and fantasy (Check the teaching schedule) ",
         "The child does not exhibit anxiety in class or in group play",
         "The child does not exhibit signs of social withdrawal (e.g.avoidsplaying with others/is unhappy or depressed)",
         "The child does not exhibit anti-social or aggressive behaviour (e.g.tells lies/ bullies others/ destroys things of others/ annoys other kids)",
         "The child listens carefully to what others say",
         "The child differentiates between real and unreal",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child understands and names at least 6-7 birds living around",
        "The child understands and names at least 6-7 insects living in our surroundings",
        "The child understands and can tell the names of houses where animals live ",
        "The child understands and can tell the names of baby animals",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to make THREE fold and crease the paper-(ensure strong creasing)",
        "The child is able to make FOUR fold and crease the paper (with strong marking ofthe crease.)",
        "The child is able to tie the shoe lace and manage the knots",
        "The child is able to fold a handkerchief with at least 4-5 types of folding",
        "The child is able to jump forward effortlessly",
        "The child is able to hold and play with large balls like a volley ball or basketball",
      ],
    },
  };
