...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child is able to identify 5 objects for every letter from A to Z (randomly as and when shown the pictures)",
        "The child says at least 4 objects as per the sound of the letter to Z",
        "The child is able to tell at least 2- 3 bits of information about the objects learned for each of the letters from A to Z (objects in the English book).",
        "The child is able to write capital and corresponding small letters in order from Ato Z and randomly",
        "The child is able to talk at least 4 things/ about the objects learned for each of the alphabet from Aa to Tra (objects in the Hindi book)",
        "The child is able to remember and sing favourite Rhymes easily English Rhyme - 1) What do I see 2) Mary had a little lamb Hindi Rhyme-1) Dhobi Aaya 2) Lal Tamatar",
        "The child is able to remember some parts of the story and tell at least 4-5 sentences 1) Lion and Fox 2) Golden Eggs",
        "The child is able to read & write 2-letter sight words",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
       "The child is able to find the missing number before a particular number",
       "The child is able to find the missing number after a particular number",
       "The child is able to find the missing number in between two numbers",
       "The child is able to differentiate and tell more or less between two set of objects, in terms of number or quantity",
       "The child is able to add two single digit numbers through object counting method",
       "The child is able to subtract one single digit number from another through object crossing method",
      ],
    },
    ...
    social: {
      ...
      questions: [
         "The child is able to tell the right time of doing a particular activity",
         "The child is able to tell the right place of doing a particular activity",
         "The child participates in classroom discussion",
         "The child exhibits some skills which is appreciated by others",
         "The child invites and involves other children to a group game/activity",
         "The child understands wrong behaviour and apologizes for the same",
         "The child sits quietly and listens to stories or other narratives",
         "The child responds appropriately (does again) when corrected",
         "The child accepts and respects decision made by teachers",
    ...
    environment: {
      ...
      questions: [
        "The child understands and names at least 4-5 vehicle names which are used as land transport",
        "The child understands and names at least 2-3 vehicle names which are used as air transport ",
        "The child understands and names at least 4-5 vehicle names which are used as water transport",
        "The child can tell at least 4-5 names out of 7 days of the week",
        "The child can tell at least 5-6 names out of 12 Months of the year",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to make a rectangle and triangle and cut it in the side with the help of baby scissors",
        "The child is able to make alphabet letters by using clay and dough",
        "The child is able to ride a tricycle rapidly",
        "The child is able to do simple yoga poses like tree, cat - camel, lotus etc",
      ],
    },
  };
