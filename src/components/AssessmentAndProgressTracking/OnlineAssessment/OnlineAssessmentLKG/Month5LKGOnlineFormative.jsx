...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child writes capital and small English letters A(a), U(u) by tracing the letters and also without tracing it -Writing skills",
        "The child is able to write Hindi alphabets `Da` to `Tha` by tracing over it and without tracing",
        "The child speaks at least 4 words as per the sound of each letter from Ato U.",
        "The child remembers and sings Rhymes easily with action English Rhyme-`  Hickory Dickory Dock, I am little Teapot and Ding dong bell",
        "The child can identify and point out the picture when described with clues (Check for all the objects from Ato U)",
        "The child understands the basic grammar rules of preposition like on, over, under etc (the child identifies where the object is and tells it correctly)",
        "The child is able to identify the picture, recognise the sound of the first letter of the word and connect the same with the particular letter in a given set of letters (For alphabets from A to U)",
        "The child is able to identify the object and able to write the first letter of the object (For alphabets from A to U)",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
        "The child is able to count number of objects upto 20 objects",
        "The child writes the number from 21 to 28 by tracing it and can say the number afterwriting it",
        "The child is able to recite the numbers 1-20sequentially",
        "The child is able to understand the differences in two pictures and show them correctly",
        "The child is able to point out the similarities and differences by the shape, size, colour, emotion and time depicted in the picture",
      ],
    },
    ...
    social: {
      ...
      questions: [
        "The child understands the usefulness of healthy food",
        "The child understands and identifies the difference between `healthy food` and `unhealthy food`",
        "The child understands and identifies healthy foods from a list of food items",
        "The child understands and identifies unhealthy foods from a list of food items",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child understands and can identify our country `INDIA` from the map",
        "The child can tell at least 4 national festivals we celebrate",
        "The child can identify and tell various national symbols",
        "The child is able to differentiate our national symbol from other symbols",
        "The child names at least 2 freedom fighters",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to walk at least 5 feet forward on toes",
        "The child is able to walk at least 5 feet forward on heels",
        "The child is able to walk at least 5 feet backwards on toes",
        "The child is able to walk at least 5 feet backwards on heels",
      ],
    },
  };
