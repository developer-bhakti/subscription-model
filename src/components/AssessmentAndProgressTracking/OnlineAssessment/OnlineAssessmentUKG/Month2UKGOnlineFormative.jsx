...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
       "The Child is able to say at least 4 objects that starts with the sound of all the English alphabet letters from A to Z",
       "The child is able to write a particular Hindi alphabet as and when dictated",
       "The Child is able to write both capital and small letters in 3 line note book as per the line as given in the syllabus book",
       "The child is able to differentiate between Vowel and Consonant",
       "The child is able to remember and sing favourite Rhymes easily 1. Ek chidiya ke Bache Char-Hindi Rhyme 2. After a Bath-English Rhyme 3. Arose is pink- English Rhyme",
       "The child understands, recognises and tells the rhyming words for given words",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
       "The child easily identifies all seven colours - VIBGYOR",
       "The child is able to count number of objects up to 20 quite easily.",
       "The child is able to identify the numbers from1 to 50",
       "The child writes the number up to 60 and can say the number after writing it",
       "The child understands and identifies numbers in between given numbers",
      ],
    },
    ...
    social: {
      ...
      questions: [
         "The child understands, and can tell the use of the sensory organs",
         "The child understands, the needs of our body",
         "The child understands the timing when we eat",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child can speak 3-5 sentences about the park as a part of our environment",
        "The child understands the meaning of market and can tell what we do at market",
        "The child understands from which shop we can buy a particular object",
        "The child understands the meaning of Hospital and can tell how hospital is useful to us",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        ...
        "The child is able to use scissor in a safer manner",
        "The child is able to cut a paper through a straight line",
        "The child is able to colour different pictures more neatly",
        "The child is able to paste multiple pieces of paper by using glue stick",
        "The child is able to colour by using water colour",
        "The child is enjoying and playing hopscotch",
      ],
    },
  };
