...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child is able to tell the name of 5 vowels",
        "The child is able to identify vowels in a given word",
        "The child is able to read 2 letter sight words beginning with a vowel",
        "The child is able to identify and tell rhyming words having phonemes `an`",
        "The child is able to create a word (from a picture) with `an` phonemes by picking the right letter",
        "The child is able to remember and sing favourite Rhymes easily 1. Ginti-Hindi Rhyme 2. All the little fishes-English Rhyme",
        "The child is able to communicate by saying simple words",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
       "The child is able to count numbers backward",
       "The child is able to identify bigger and smaller objects in a given set of objects",
       "The child is able to find the missing number in between two numbers",
       "The child is able to arrange objects from smaller to bigger objects in a given set of objects",
       "The child is able to arrange objects from bigger to smaller objects in a given set of objects",
       "The child writes numbers upto 70 and can say the number",
      ],
    },
    ...
    social: {
      ...
      questions: [
         "The child understands and identify all the food items we get from plants",
         "The child understands and identify all the food items we get from animals",
         "The child understands and identifies various emotions",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child can speak 3-5 sentences about the bank as a part of our environment",
        "The child can speak 3-5 sentences about the Domestic animals as a part of our environment ",
        "The child can identify Domestic animals and their young ones",
        "The child can speak 3-5 sentences about the Wild animals as a part of our environment",
        "TThe child can identify Wild animals in a given set of pictures of animals",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        ...
        "The child plays the HOPSCOTH game and enjoys it",
        "The child negotiates hurdles without any difficulty",
        "The child is able to colour by using water colour and brush",
        "The child is able to transfer water from one bowl to another by using a sponge",
        "The child is able to assemble small building blocks",
        "The child is able to write by using a pencil very comfortably",
        "The child is able to wash face unassisted",
      ],
    },
  };
