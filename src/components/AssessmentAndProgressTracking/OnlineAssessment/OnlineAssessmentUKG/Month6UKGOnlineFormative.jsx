...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The Child is able to identify and tell the rhyming words having the phonetics - `ig`, `in`, `id`, `im`, `ip` and `it` (phonetics skill)",
        "The Child is able to form and write at least 3 words for each phonetic extension `ig`, `in`, `id`, `im`, `ip` and `it` (phonetics skill)",
        "The Child is able to read and write short sentences with 'i' vowel words in them",
        "The child is able to identify and read words with `Ei`, `Eei` and `Uu` ki matra",
        "The child is able to write words with `Ei`, `Eei` and `Uu` ki matra",
        "The child is able to tell some part of the story - Lion and mouse",
        "The child is able to remember and sing rhyme English Rhyme- Cherry Tree, Mummy Hindi Rhyme-Meri Gudia",
        "The child is able to communicate with more information about familiar people and places",
        "The child writes small sentences when dictated",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
       "The child is able to identify and count numbers by 2s",
       "The child is able to identify and count numbers by 3s",
       "The child is able to recite numbers from 100-150 in order",
       "The child is able to identify more number of items in a given container than other container",
       "The child is able to identify if a number is greater than another number",
       "The child is able to identify if a number is less than another number",
      ],
    },
    ...
    social: {
      ...
      questions: [
         "The child is able to identify all the items in a first aid box",
         "The child is aware about the value of money, so knows to protect it",
         "The child follows the right behaviour in a given emotion",
         "The child shares own things/belongings (food/ toy/pencil etc) with other friends",
         "The child does not yell or shout when angry",
         "The child does not exhibit unpredictable behaviour (sudden anger / sudden sadness etc.)",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child understands and names at least 7-8 vehicle names which are used as land transport",
        "The child says at least 3 lines about Railway station",
        "The child understands and and says at least 4-5 names that are used as Air transport ",
        "The child understands the meaning of Airport",
        "The child understands and says at least 5-6 names that are used as water transport",
        "The child can tell at least 4-5 names of communication system",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to cut (baby scissor) and paste picture on paper",
        "The child is able to cut paper into different shapes",
        "The child is able to draw the boundaries of an object",
        "The child is able to make a bracelet by using a thread and beads",
        "The child is able to jump inside a circle of various sizes",
        "The child is able play dog and bone game with proper attention",
      ],
    },
  };
