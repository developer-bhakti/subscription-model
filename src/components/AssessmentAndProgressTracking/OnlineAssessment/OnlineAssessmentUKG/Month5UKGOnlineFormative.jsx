...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child is able to read all the single syllable words with vowel `a` in it",
        "The child is able to identify and tell the rhyming words having the phonetics - `eg`, `en`, `ed`, `et`",
        "The child is able to make a list of words with vowel `e` in it with the help of pictures by picking the correct letters",
        "The child is able to read and write short sentence with `eg`, `en`, `et`, phoneme words in it",
        "The child is able to read Hindi words and describe the picture in 2-3 sentences",
        "The child is able to write the missing Hindi letter in a given word by looking at its pictures (`aa` matra words)",
        "The child is able to remember and sing favourite Rhymes easily -1. Thank you god 1 0.5 0 -2. The ten little fingers",
        "The child is able to remember and tell a part of the following story Honest Woodcutter Or any other story that is taught to the child",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
       "The child is able to write ONE to TEN in words for the numbers",
       "The child is able to fill the missing letter in a given word for the numbers from 1 to 10",
       "The child is able to read the words of number names from 11-20",
       "The child writes the number up to 90 and can say the number",
       "The child is able to visually compare two sets of objects and identify which is `More`",
      ],
    },
    ...
    social: {
      ...
      questions: [
         "The child can tell whether a given behaviour is `Right` or `Wrong` for a good social behaviour ",
         "The child understands various emotion in a given picture",
         "The child understands and knows the difference between a positive and negative emotion",
         "The child understands and knows when we are `sad` and ways to come out of it",
         "The child understands and knows when we are `angry` and ways to come out of it",
         "The child understands and is able to draw a picture to describe a happy face, a sad face and an angry face",
         "The child does not exhibit temper outburst/ tantrum",
         "The child does not exhibit signs of social withdrawal (avoids playing with others/unhappy or depressed)",
         "The child shows self-control and avoids aggression during a conflict with other children",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child is able to dance freely at least for 3-5 minutes",
        "The child is able to shape clay dough into figures",
        "The child is able to crawl freely at least for 3-5 minutes",
      ],
    },
