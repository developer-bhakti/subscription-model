...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The Child is able to identify and tell the rhyming words having the phonetics `up`,`ug`,`ut`,`un`, `ud`",
        "The Child is able to read and write short sentences with words having `u` in them",
        "The Child is able to say the opposite of a particular word",
        "The Child is able to understand the concept of singular and plural and use it correctely",
        "The Child is able to understand and use `this` and `that` correctly",
        "The child is able to identify and read words with `Aun` and `Aum` ki matra",
        "The child is able to write words with `Aun` and `Aum` ki matra",
        "The child is able to read and write short Hindi sentences having words with matra in it (optional)",
        "The child is able to tell some part of a story Story- The crow and the Fox",
        "The child is able to remember and sing a rhyme English Rhyme- The Clown",
        "The child is able to communicate with simple story (English, Hindi and Mother Tongue)",
        "The child is able to communicate about own experience (English, Hindi and Mother Tongue)",
        "The child is able to write small sentence having singular/plural, she/he, this/that, a/an when dictated",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
       "The child is able to recite and write numbers 1-200 in order",
       "The child is able to identify any given number between 1 to 200",
       "The child is able to subtract one number from another by picture crossing method",
       "The child is able to subtract one number from another by number line method",
       "The child is able to identify and create common shapes",
      ],
    },
    ...
    social: {
      ...
      questions: [
         "The child knows how to wash hands properly",
         "The child knows how to practice good hygiene",
         "The child understands and differentiates between healthy and unhealthy foods",
         "The child is not too much self centred and given attention to other children and their problem",
         "The child is not impulsive in talks and behaviour",
         "The child obeys all the rules taught",
         "The child completes all the task given till the finishing point (does not leave an activity in between)",
         "The child participates in classroom discussion",
         "The child understands all the social acceptable behaviour and behaves accordingly",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child says 3 lines about our country",
        "The child understands, remembers and names at least 2-3 of our freedom fighters",
        "The child understands, remembers and identifies at least 2-3 of our national symbols (flower, animal, flag, emblem)",
        "The child is able to name few of our religious places",
        "The child understands, remembers and names at least 4-5 festivals we celebrate",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to make paper wave design by using different size of paper",
        "The child is able to make cotton bud painting",
        "The child is able to punch out a pattern on a paper using tooth pick",
        "The child is able to transfer water from one glass to another without spilling water",
        "The child is able to shift marbles from one container to another with the help of a spoon",
      ],
    },
  };
