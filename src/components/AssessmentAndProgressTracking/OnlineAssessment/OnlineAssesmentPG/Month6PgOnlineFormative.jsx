...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child is able to understand and identify the SOUND of most of the letters",
        "The child can identify ONE object that starts with the sound of the letters A to T",
        "The child recognizes the pattern of the letters Q,R,S,T",
        "The child loves to follow the pattern of letters with Crayon by scribbling on it",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
        "The child is able to identify numbers",
        "The child can identify a picture with one object from the pictures of different number of objects",
        "The child can identify the object that is one unit in a group of objects",
        "The child can follow instructions to pick up a single object from a group of objects",
        "The child is able to colour a single object from a list of similar objects by differentiating it",
        "The child is able to identify numbers 8,9,10",
      ],
    },
    ...
    social: {
      ...
      questions: [
        "The child understands the idea of cleanliness",
        "The child can differentiate between dirty and clean objects",
        "The child differentiates between dirty and clean surroundings",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child is able to recognise transport vehicles School bus, Lorry",
        "The child identifies fruits - Papaya, Kiwi",
        "The child identifies and names vegetables - Chilli, Pumpkin",
        "The child is able to recognise and name the wild animals Monkey, Zebra",
        "The child identifies Birds - Parrot, Pigeon",
        "The child understands words mentioned in the 'Garden' picture`",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to hold thick crayons and scribble vertical lines",
        "The child is able to hold thick crayons and scribble horizontal 1 lines ",
        "The child is able to draw vertical lines on sand",
        "The child is able to draw horizontal lines on sand",
        "The child is able to make line patterns using clay",
        "The child is able to trace a straight line",
        "The child is able to do yoga poses like bending, stretching, twisting",
      ],
    },
  };
