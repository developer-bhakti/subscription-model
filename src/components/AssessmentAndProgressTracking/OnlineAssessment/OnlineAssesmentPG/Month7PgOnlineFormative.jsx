...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child is able to identify letters U, V,W,Х",
        "The child can identify one object that starts with a particular letter",
        "The child follows the pattern of the letter with crayon and scribbles on it",
        "The child is able to recite A to Z",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
        "The child can identify the real object and a toy (unreal) Vegetable/Fruit",
        "The child can identify the real object and a toy (unreal) Mobile phone",
        "The child is able to identify any given number between 1 to 10",
        "The child is able to recite numbers 1 to 10",
        "The child is able to understand from the picture if it is a real photo or a drawn picture of any object",
      ],
    },
    ...
    social: {
      ...
      questions: [
        "The child uses the spoon for eat some foods",
        "The child can identify food items that can be eaten by using a spoon",
        "The child understands and builds relationship with others",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child is able to recognize transport vehicles - Dump track, Bulldozer, Ship",
        "The child identifies and names vegetables - Cucumber, Pottato",
        "The child is able to recognize and name animals - Horse, Camel, Deer, Kangaroo",
        "The child identifies birds - Owl, Penguin",
        "The child understands the shops in the 'Market`",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to trace lines in a structured way (Without much deviation)",
        "The child is able to balance on a plank for 5-10 seconds",
        "The child is able to put on clothes if unbuttoned",
        "The child is able to take off clothes if unbuttoned",
      ],
    },
  };
