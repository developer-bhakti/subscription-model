...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child is able to recite the alphabets A to Z",
        "The child is able to identify and say 1 object for each letter from A to Z",
        "The child is able to identify some letters of the alphabets",
        "The child is able to understand verbal instructions asked through a `question`",
        "The child is able to understand verbal instructions asked through a `question`",
        "The child is able to answer (name the object) when a question is asked like `What is this?` by showing a common object like crayon, pencil, book, mobile etc.",
        "The child is able to understand and identify the right object when their usage is described",
        "The child understands the instructions completely and follows them without any difficulty",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
        "The child is able to recite numbers upto 15",
        "The child attempts counting various objects at school or at home",
        "The child is able count pictures in a book (up to 5 pictures)",
      ],
    },
    ...
    social: {
      ...
      questions: [
        "The child uses words (like Good morning) to wish elders and peers",
        "The child responds to a wish (like Good morning)",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child is able to recognize and name the animals - Donkey, Rabbit, Bear",
        "The child identifies the vegetables - Brinjal, Broccoli",
        "The child is able to identify and name transport vehicles - Train, Metro, Air balloon, Rocket",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to run in a straight line",
        "The child is able to trace and colour a square within the boundary",
        "The child is able to trace and colour a triangle within the boundary",
        "The child is able to trace and colour a circle within the boundary",
        "The child is able to trace and colour a star within the boundary",
      ],
    },
  };
