...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child is able to understand the action words",
        "The child is able to verbalise his/her wants (able to speak the needs).",
        "The child is able to recognize letters J, K, L",
        "The child is able to pair 2 or 3 words and speak",
        "Then child is able to pick up words from an overheard conversation.",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
        "The child is able to count objects of 2 and 3 numbers",
        "The child is able to understand different colours and differentiate two objects of different colours",
        "The child is able to identify numbers 1 to 4",
      ],
    },
    ...
    social: {
      ...
      questions: [
        "The child helps adults in various activities.",
        "The child participates in dressing by self ",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child is able to recognize transport vehicles - Van, Helicopter, Airplane",
        "The child identifies fruits - Watermelon, Grapes",
        "The child identifies vegetables - Green peas, Cauliflower",
        "The child identifies animals - Pig, Buffalo",
        "The child is able to point at birds - Mynah, Hen when named",
        "The child shows interest in the picture 'Picnic' and attempts to say new words from it",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to throw the ball upwards",
        "The child is able to kick a stationary ball",
        "The child is able to clap with music and enjoy.",
        "The child is able to jump with two legs",
        "The child is able to turn pages of a book one by one.",
        "The child is able to build blocks of at least 4 blocks.",
        "The child is able to tear paper",
        "The child is able to hold thick crayons and scribble",
      ],
    },
  };
