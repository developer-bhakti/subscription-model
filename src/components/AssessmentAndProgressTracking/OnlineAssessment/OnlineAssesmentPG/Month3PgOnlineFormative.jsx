...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child repeats and recites letters taught A to l.",
        "The child is able to point out the body parts when they are named.",
        "The child is able to point out to the family members when their names are taken.",
        "The child shows interest in listening to stories.",
        "The child is able to talk more frequently in small sentences.",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
        "The child is able to identify the bigger objects between two objects",
        "The child is able to identify the smaller object between twoobjects.",
        "The child points and identifies numbers 1, 2 and 3",
      ],
    },
    ...
    social: {
      ...
      questions: [
        "The child copies other children in different play activities.",
        "The child copies adults in different activities",
        "The child participates in clean habits - Washing hands and Drying.",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child identifies transport vehicles - Truck, Fire engine, Ship,Boat.",
        "The child identifies fruits and vegetables - Pear, Orange, Capsicum, Cabbage.",
        "The child identifies birds - Sparrow, Crow",
        "The child identifies wild animals - Lion, Tiger",
        "The child identifies and names objects in a classroom",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child removes shirt or frock if unbuttoned.",
        "The child is able to hold a thick crayon with the thumb and fingers and colour with it..",
        "The child responds to music with dance movements.",
        "he child is able to walk upstairs at least 4-6 stairs with both feet.",
        "The child is able to paint with the help of a large brush.",
      ],
    },
  };
