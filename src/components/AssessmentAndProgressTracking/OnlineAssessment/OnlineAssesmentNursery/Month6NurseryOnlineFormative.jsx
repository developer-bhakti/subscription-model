...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child is able to identify at least 3 objects as per the sound of letters `I` to `N`",
        "The child is able to trace and write letters `I` to `N`",
        "The child understands the sound and pronounces the Hindi letter `Nna`, `Ta`, `Na`, `Pa`, `Pha`, `Ba`, `Bha`, `Ma` and `Ya` without any difficulty- Phonemes skill for Hindi alphabets",
        "The child is able to identify and say at least one object as per sound of the Hindi letter `Nna`, `Ta`, `Na`, `Pa`, `Pha`, `Ba`, `Bha`, `Ma` and `Ya` without any difficulty- Phonemes skill for Hindi alphabets",
        "The child is able to remember and sing the Rhymes with action: English Rhyme-`Jonny-Jonny`, `Jack and Jill`",
        "The child is able to remember and sing the Rhymes with action: Hindi Rhyme- `Machli`",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
        "The child is able to trace and write numbers from 10 to 13",
        "The child is able to recite number 1 to 15 in order",
        "The child is able to differentiate and sort any group of objects",
        "The child is able to understand and differentiate all the objects which are unusual in nature (i.e cat driving a car)",
      ],
    },
    ...
    social: {
      ...
      questions: [
        "The child is able to understand and identify few food items which are healthy",
        "The child is able to differentiate between healthy and unhealthy foods",
        "The child knows and understands the timings of our eating habits",
        "The child knows and is able to tell various rules we follow while eating our food (like not talking while eating etc.)",
        "The child understands jokes and laughs at a joke",
        "The child tries to tell a joke or something to laugh about",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child understands various festivals we celebrate at home like Diwali, Eid, Christmas etc. (at least 4-5 festivals)",
        "The child knows what we do or eat on the festivals days",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to manage all kinds of patterns comfortably (tracing and without tracing)",
        "The child is able to walk in many ways... (like walking like a bird)",
      ],
    },
  };
