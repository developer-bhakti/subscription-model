...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child is becoming proficient in identifying pictures based on some description about the picture - Improved Understanding of picture through vocabulary explanation",
        "The child is able trace and write `A` to `Z`",
        "The child is able to identify at least 3 objects (as given in the syllabus book) for alphabets `A` to `Z` based on some description about the object (refer the activity sheets NL 66 to NL 75)",
        "The child is able to remember and sing the Rhymes with action: English Rhyme- `One Two`",
        "The child is able to remember and sing the Rhymes with action: Hindi Rhyme- `Titli`,`Badal Raja`,`Haathi Aaya`",
        "The child is able to remember some part of the story and tries to tell a part of the story with action: (refer PRIME Technique) Story- `Hare and the Tortoise` or `Fox and Grapes`",
        "The child speaks to connect with people in more meaningful way (for a specific query/ purpose)",
        "The child remembers and speaks about past experiences",
        "The child speaks effectively to connect with people who are less known or unknown",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
        "The child is able to recite numbers 1 to 20",
        "The child is able to identify and trace numbers 1 to 20",
        "The child picks pictures having two objects from a stack of pictures, when instructed",
        "The child picks two objects from a container of many objects, when instructed ",
        "The child is able to copy different shapes by focusing on its size and shape (ensure that the child is copying the shape as it is without much deviation in its size)",
        "The child is able to build with the building blocks of at least 6 blocks",
        "The child is able to solve puzzles of 3-4 pieces",
      ],
    },
    ...
    social: {
      ...
      questions: [
        "The child is able to identify strangers and is aware about dealing with them",
        "The child is able to identify hazardous objects and is aware about handling them carefully.",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to make different shapes using clay or dough",
        "The child is able to tie and untie a ribbon",
        "The child is able to open and close the cap of a bottle quite comfortably",
        "The child is able to open the latch of a door",
        "The child is able to clap at different rhythms",
      ],
    },
  };
