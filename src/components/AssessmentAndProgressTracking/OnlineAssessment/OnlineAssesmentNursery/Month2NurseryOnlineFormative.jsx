...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child pronounces the letters A to Z without any difficulty Phonemes skillfor English Alphabets",
        "The child identifies the letters Ato Z without any difficulty",
        "The child speaks at least one word as per the sound of each letter from A to Z",
        "The child is able to identify at least 3 objects as per the sound of letter for the letters from `A` to `J`",
        "The child is able to remember and sing the Rhymes:Hindi Rhyme- `Machli Jal ki Rani` English Rhyme- `Teddy Bear Teddy Bear`",
        "The child pronounces the letters `Aa` to `Aai` without any difficulty-Phonemes skill for Hindi alphabets",
        "The child speaks at least one word as per the sound of the Hindiletters from `Aa` to `Aai`",
        "The child is able to tell his/her name without any difficulty",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
        "The child understands the bigger and smaller objects and identifies either the bigger or smaller object in a given set of objects",
        "The child understands and identifies the picture drawn by self",
        "The child is able to classify objects or pictures into known categories",
        "The child is able to identify and say the numbers from 1 to 4",
        "The child understands that numbers can be counted - 1,2 through objects",
        "The child is able to recite numbers 1 to 5",
      ],
    },
    ...
    social: {
      ...
      questions: [
        "The child is able to differentiate between edible and non-edible items/objects",
        "Child Loves and is ready to Play make believe games",
        "The child loves to explore things around",
        "The child is not showing defiant behavior",
        "The child copies adults and other children",
        "The child defends own possessions",
        "The child gains self-help skills(eg. close snack box and put it in the bag",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child understands and identifies domestic animals",
        "The child understands and identifies wild animals",
        "The child understands and identifies water animals",
        "The child understands and identifies birds",
    ...
    movement: {
      ...
      questions: [
        "The child is able to draw sleeping lines/ standing lines without any difficulty",
        "The child is able to draw slanting or diagonal lines without any difficulty",
        "The child throws the ball overhead",
        "The child claps well with music",
        "The child jumps well by putting both the legs together",
        "The child loves kicking the stagnant ball",
