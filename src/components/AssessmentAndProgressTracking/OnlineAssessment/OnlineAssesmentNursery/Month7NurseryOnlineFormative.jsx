...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child is able to identify pictures based on some description about the picture. (Understanding picture through vocabulary explanation)",
        "The child is able to trace and write `O` to `V`",
        "The child is able to identify at least 3 objects (as given in the syllabus book) for letters `A` to `P` based on some description about the object (refer the activity sheets NL50 to NL65)",
        "The child is able to identify and speak at least one object as per sound of the Hindi letters `ra` to `tra` without any difficultyPhonemes skill for Hindi alphabets",
        "The child is able to remember and sing the Rhymes with action: English Rhyme- `Humty Dumpty`, `Ringa Ringa`",
        "The child is able to remember and sing the Rhymes with action: Hindi Rhyme- `Chanda Mama`, `Rail Gadi`",
        "The child speaks to connect with objects in a more meaningful way (like `I play with my bat`, `I love apple` etc.)",
        "The child speaks to connect with people in a more structured way (like `I playwith my dad`, `I love my teacher`etc.)"
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
        "The child is able to understand and differentiate between real and unreal (fantasy) objects/things etc. (like real vegetable and toy vegetable etc.)",
        "The child is able to trace and write numbers from 14 to 17",
        "The child plays associatively with toys with buttons. The child follows a specific pattern during the play (check the teaching schedule for details)",
        "The child plays associatively with toys having levels and wheels. The child follows a specific pattern (play it slowly/ fast etc.) while playing (check the teaching schedule for details)",
        "The child is able to follow instructions correctly which involve objects with different colours, different shapes and different numbers"
      ],
    },
    ...
    social: {
      ...
      questions: [
        "The child shows right behaviour when someone extends help",
        "The child reciprocates and responds with smile when greeted",
        "The child shows concern for troubled animals",
        "The child shows concern for a crying baby",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child knows names of the places we workship",
        "The child is comfortable in doing various exercises in the book as per the teaching schedule",
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to make small greeting cards for various occasion",
        "The child is able to crush papers to make paper balls by using different sized papers",
        "The child is able manage various physical movements including crawling like a caterpiller",
        "The child is able to do simple yoga poses with bending/stretching",
      ],
    },
  };
