...
export default function FormativeAssessmentTool() {
  const skillData = {
    language: {
      ...
      questions: [
        "The child is able to identify sounds of letters `A` to `Z`",
        "The child is able to identify at least 3 objects as per the sound of letters `T` to `Z`",
        "The child is able to trace and write letters `A` and `B`",
        "The child identifies and speaks at least one word as per the sound of Hindi letters `ga, gha, cha, chha`",
        "The child is able to remember and sing the Rhymes with action: English Rhyme- `Learn ABCD` and `Rolly Polly`",
      ],
    },
    ...
    cognitive: {
      ...
      questions: [
        "The child is able to trace & write numbers from 1 to 6",
        "The child is able to identify at least 4 shapes including square, circle, rectangle and oval ",
        "The child is able to identify at least 4 colours including red, green, yellow and blue",
        "The child is able to sort objects having the combination of 4 colours and 4 shapes",
      ],
    },
    ...
    social: {
      ...
      questions: [
        "The child is able to understand and identify major body parts",
        "The child shows the body parts when named",
        "The child specifically identifies the 5 sense organs",
        "The child is aware of daily activities for good health",
        "The child knows about how our eyes help us",
        "TThe child knows about how our nose helps us",
        "The child knows about how our tongue helps us",
        "The child knows about how our skin/hand (touch) helps us",
      ],
    },
    ...
    environment: {
      ...
      questions: [
        "The child understands and identifies various flowers",
        "The child understands the use of various furniture at home and at school",
        "The child is able to understand various instruments and machines at home, those make our life easy"
      ],
    },
    ...
    movement: {
      ...
      questions: [
        "The child is able to draw small circles without any difficulty",
        "The child walks in the room unattended",
        "The child can mark with pencil, crayon and chalk",
        "The child is able to move objects from one place to another",
        "The child is able to overcome small obstacles",
        "The child is able to remove the shirt or frock if unbuttoned",
        "The child is able to use spoon for eating",
        "The child is able to put on the shirt or frock unassisted",
        "The child is able to stand and walk on tiptoe",
      ],
    },
  };
