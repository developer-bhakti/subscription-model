export const sections = [
    { title: "Home", path: "/user", icon: "🏠" },
    { title: " Curriculum & Academic Resources", path: "/user/curriculum", icon: "📘" },
    { title: "Classroom Activity And Worksheet Library", path: "/user/worksheet", icon: "📝" },
    { title: "Online Tools for Skill Development", path: "/user/online-games", icon: "🎮" },
